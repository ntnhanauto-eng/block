...
// 2. THUẬT TOÁN ĐÃ ĐƯỢC SỬA: Đối soát chuẩn xác mốc thời gian dọn buồng phòng
// l1: Quét các log chuyển phòng sang trạng thái chờ vệ sinh (Check-out hoặc Lễ tân đổi)
// l2: Quét các log chứa chuỗi hoàn tất dọn dẹp vệ sinh phòng (Cả hai đều thuộc event_type = 'LỄ TÂN')
$perf_sql = "
    SELECT 
        r.room_name, 
        l1.event_time as start_time, 
        l2.event_time as end_time,
    ...
    WHERE (l1.details LIKE '%vệ sinh%' OR l1.details LIKE '%ve_sinh%') 
      AND l1.details NOT LIKE '%hoàn tất%'
      AND l2.details LIKE '%hoàn tất%vệ sinh%'
