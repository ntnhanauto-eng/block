...
// Quy trình quét ngầm: Nếu có bản ghi "BẤT THƯỜNG" xuất hiện trong vòng 10 giây qua, đẩy tin khẩn cấp ngay.
...
if (mysqli_num_rows($check_alert_query) > 0) {
    ...
    // Kiểm tra và gọi hàm gửi Telegram (Hàm đã được định nghĩa sẵn trong config.php của bạn)
