...
<head>
    ...
    <style>
        ...
        /* KHUNG CHỐNG TRÀN VÀ CUỘN NGANG CHO BẢNG */
        ...
        table { width: 100%; border-collapse: collapse; min-width: 750px; /* Khóa độ rộng tối thiểu của bảng tránh ép bóp nát chữ */ }
        th, td { padding: 12px; font-size: 13px; text-align: left; border-bottom: 1px solid #f1f5f9; white-space: nowrap; /* Giữ chữ thẳng hàng, không xuống dòng bừa bãi */ }
        th { background: #f8fafc; color: #475569; font-weight: bold; }
        
        /* Phân bố cột hợp lý */
        th:nth-child(1), td:nth-child(1) { min-width: 60px; }  /* ID */
        th:nth-child(2), td:nth-child(2) { min-width: 140px; } /* Thời gian */
        th:nth-child(3), td:nth-child(3) { min-width: 90px; }  /* Phòng */
        th:nth-child(4), td:nth-child(4) { min-width: 100px; } /* Sự kiện */
        th:nth-child(5), td:nth-child(5) { min-width: 110px; } /* Số tiền */
        th:nth-child(6), td:nth-child(6) { white-space: normal; min-width: 250px; } /* Chi tiết bản ghi */

        .alert-red { background-color: #fff1f2 !important; color: #9f1239; font-weight: bold; }
        ...
        /* ĐIỀU CHỈNH GIAO DIỆN LỚN TRÊN MÁY TÍNH (PC / TABLET) */
                ...
                <?php if (mysqli_num_rows($all_logs) > 0): ?>
                    <?php while($l = mysqli_fetch_assoc($all_logs)): ?>
                        ...
                        <tr class="<?php echo $row_class; ?>">
                            ...
                            <td style="font-weight: bold; text-align: right; color: <?php echo $money_display > 0 ? '#28a745' : '#64748b'; ?>;">
