...
<head>
    ...
    <style>
        ...
        /* HIỆU ỨNG NHẤP NHÁY KHẨN CẤP QUÊN ĐÓNG CỬA */
        ...
        table { width: 100%; border-collapse: collapse; min-width: 600px; /* Khóa chiều rộng tối thiểu của bảng để kích hoạt thanh cuộn ngang mượt mà, không bị bóp nghẹt chữ */ }
        th, td { border: none; border-bottom: 1px solid #eee; padding: 10px 12px; text-align: left; font-size: 13px; white-space: nowrap; /* Ngăn chặn tuyệt đối việc ép chữ xuống dòng làm lệch bảng */ }
        th { background: #f8f9fa; color: #34495e; font-weight: bold; }
        
        /* Cố định cấu trúc cột hợp lý */
        th:nth-child(1), td:nth-child(1) { min-width: 120px; } /* Thời gian */
        th:nth-child(2), td:nth-child(2) { min-width: 90px; }  /* Tên phòng */
        th:nth-child(3), td:nth-child(3) { min-width: 90px; }  /* Đánh giá */
        th:nth-child(4), td:nth-child(4) { white-space: normal; min-width: 250px; } /* Nội dung chi tiết cho phép xuống dòng nếu quá dài */
        ...
        @media (min-width: 768px) {
            ...
            /* Máy tính hiện 4 đến 5 phòng trên một hàng */
            ...
            table { min-width: 100%; } /* Trở lại full màn hình nếu màn máy tính rộng */
            
            /* Máy tính nằm ngang lại thành hàng ngang */
